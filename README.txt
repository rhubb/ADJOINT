...
Code in this repository generates simulation inputs based on Breast Cancer Surveillance Consortium data, reads in simulation inputs, and executes simulations as described in the paper. Code should be run in the following order:
...
Simulations can be run based on inputs in the inputs directory without requiring raw BCSC data. BCSC data is available by request to the authors and BCSC Steering Committee, with appropriate regulatory approvals.